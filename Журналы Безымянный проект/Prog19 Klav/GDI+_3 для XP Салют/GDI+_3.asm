...
AppName   db "все, что нельзя запрограммировать на masm - можно спаять... Fireworks MMX",0,0,0,0,0,0
info      db "Fireworks. Срочно учите GDI+. Freeware",13,10
          db  13,10
          ...
          db "Entire source code of this program is free available at my website. ",0
seed      dd 2037280626
...
.data
 fps  db 64 dup (0)
 fmat db "fps = %u [С профессиональным программированием!]",0
.code
